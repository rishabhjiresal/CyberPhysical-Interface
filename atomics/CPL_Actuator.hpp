...
// 		CPL_Actuator(PinName TempPin) noexcept {
//       new (this) Sensor(TempPin, TIME("00:00:05:000"));
//     		}

//         CPL_Actuator(PinName TempPin, TIME rate) noexcept {
//           pollingRate = rate;
...
//     template<typename TIME>
//     class CPL_Actuator : public iestream_input<Sensor_Message,TIME, CPL_Actuator_defs>{
//       public:
//         CPL_Actuator() = default;
//         CPL_Actuator(const char* file_path) : iestream_input<Sensor_Message,TIME, CPL_Actuator_defs>(file_path) {}
//         CPL_Actuator(const char* file_path, TIME t) : iestream_input<float,Sensor_Message, CPL_Actuator_defs>(file_path) {}
//     };
